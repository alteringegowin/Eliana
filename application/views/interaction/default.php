    ...
    <div class="block_content">
        ...
        <div id="statistic" class="ui-widget">
            <div class="statistic-num" style="width: 90px;">
                ...
                <a href="#" class="buttonUI">Download Data</a>
            </div>
        ...
        <table id="sort-col2" cellpadding="0" cellspacing="0" width="100%">
            ...
            <tbody>
                <?php foreach ($interactions as $r): ?>
                    ...
                    <tr>
                        <td><?php echo anchor('interaction/tweet/'.$keyword_id.'/'.$start.'/'.$end, $r->tanggal) ?></td>
        ...
        <table id="sort-col2" cellpadding="0" cellspacing="0" width="100%">
            ...
            <tbody>
                <?php foreach ($users as $r): ?>
                    ...
                    <tr>
                        <td><?php echo $r['t_screen_name'] ?></td>
                        <td><?php echo $r['t_counted'] ?></td>
                        <td>&nbsp;</td>
                        <td><?php echo $r['f_screen_name'] ?></td>
